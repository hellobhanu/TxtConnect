...
function Ok()
{
	...
	var videofield = window.top.document.getElementById("edit-field-video-0-url");
	//alert(videofield.value);
	videofield.value =  GetE('txtUrl').value;
	return true ;
}
